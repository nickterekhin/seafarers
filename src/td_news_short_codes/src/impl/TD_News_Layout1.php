...
class TD_News_Layout1 extends TD_News_Base
{
    ...
    {
        parent::__construct('td_news_layout1');
        $this->short_code_title = "TDN Layout1";
        $this->template_layout='layout1';
    ...
    {
        return $this->View('l1/qode_news_item',array_merge(array('obj'=>$this),$this->short_code_params));
    }
}
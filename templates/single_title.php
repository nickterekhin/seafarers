					...
					<div class="container">
						<div class="container_inner clearfix">
								...
								<?php } ?>
									...
									<?php } ?>
									<h1 style="display:none"<?php print $page_title_animation_data; if(get_post_meta($id, "qode_page-title-color", true)) { ?> style="color:<?php echo get_post_meta($id, "qode_page-title-color", true) ?>" <?php } ?>><span><?php qode_title_text(); ?></span></h1>

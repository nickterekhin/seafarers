					...
					<div class="container">
						<div class="container_inner clearfix">
								...
								<?php } ?>
									...
									<?php } ?>
									<h1 <?php print $page_title_animation_data; if(get_post_meta($id, "qode_page-title-color", true)) { ?> style="color:<?php echo get_post_meta($id, "qode_page-title-color", true) ?>;display:none;" <?php } ?>><span><?php qode_title_text(); ?> - Hello</span></h1>

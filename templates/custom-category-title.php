<?php
/** @var TD_Framework $terekhin_framework
 *  @var WP_Term $obj;
 */
use TerekhinDevelopment\framework\TD_Framework;

global $qode_options_proya,$terekhin_framework,$wp_query;
...
$title_image = $terekhin_framework->getImageTitle($obj->taxonomy,$obj->term_id);

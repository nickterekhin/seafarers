...
<div class="terekhindev-news-date-filter">
    <form action="<?php echo $terekhin_framework->getFormAction($obj); ?>" method="post" id="terekhindev-news-date-search-form">
        ...
        <div style="overflow: hidden">
            <input id="terekhindev-news-date-search" value="<?php echo $_GET['date-filter'];?>" placeholder="Select date" name="search-news-date" readonly="readonly" class="datepicker" type="text">
        </div>
